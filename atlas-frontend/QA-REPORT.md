...
- Switched `AppShell` to the lightweight guest navbar during Atlas QA-mode audits so protected-route Lighthouse runs stop paying unnecessary authenticated-shell overhead.
