...
- [2026-03-29] ⚠️ Older feature-branch worktrees can lag behind canonical shared support files; if a branch suddenly loses modules like DRF auth helpers, compare it with the main workspace before treating the missing import as a fresh regression.
