      ...
      routes: [
        {
          ...
          component: StubPage,
          meta: {
            title: 'Scope — Discover spots, map stories, and plan smarter trips',
            description: 'Scope default home shell.',
            robots: 'index,follow',
          },
        },
        {
      ...
      routes: [
        ...
        },
        {
          ...
          meta: {
            ...
            description: 'The requested Scope route could not be found.',
