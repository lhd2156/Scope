...
ModuleInfo getModuleInfo() {
  return {
    "0.3.0",
    true,
    "Phase 23.3 clustering, haversine, and convex hull helpers ready",
  };
}
...
EMSCRIPTEN_BINDINGS(atlas_wasm_module) {
  ...
  function("calculateHaversineDistance", &atlas::calculateHaversineDistance);
  function("clusterViewportPoints", &atlas::clusterViewportPoints);
  function("buildViewportConvexHull", &atlas::buildViewportConvexHull);
}
