...
SPOT_MAPPINGS = {
    'mappings': {
        'properties': {
            ...
            'tags': {'type': 'text', 'analyzer': 'standard', 'fields': {'keyword': {'type': 'keyword'}}},
            'city': {'type': 'text', 'analyzer': 'standard', 'fields': {'keyword': {'type': 'keyword'}}},
            'country': {'type': 'keyword'},
            'vibe': {'type': 'text', 'analyzer': 'standard', 'fields': {'keyword': {'type': 'keyword'}}},
...
REVIEW_MAPPINGS = {
    'mappings': {
        'properties': {
            ...
            'spot_is_public': {'type': 'boolean'},
            'spot_owner_id': {'type': 'keyword'},
