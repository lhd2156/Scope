...
} from '@/services/tripPlanHeuristics';
...
function buildSocialConversationalAnswer(
...
function buildContextConversationalAnswer(
  intent: ConversationalIntent,
  route: string,
  travelerRequest: string,
  recentChat: string,
...
function buildBoundaryConversationalAnswer(
  intent: ConversationalIntent,
  travelerRequest: string,
  recentChat: string,
  repeatCount: number,
...
function buildFallbackConversationalAnswer(
  intent: ConversationalIntent,
  travelerRequest: string,
  recentChat: string,
  repeatCount: number,
...
function buildConversationalAnswer(
  ...
  return (
    buildSocialConversationalAnswer(intent, route, travelerRequest, recentChat, repeatCount)
    ?? buildContextConversationalAnswer(intent, route, travelerRequest, recentChat, repeatCount)
    ?? buildBoundaryConversationalAnswer(intent, travelerRequest, recentChat, repeatCount)
    ?? buildFallbackConversationalAnswer(intent, travelerRequest, recentChat, repeatCount)
  );
}
