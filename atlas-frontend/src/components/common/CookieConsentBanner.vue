<template>
  <Transition name="cookie-consent-banner">
    <section
      ...
      class="cookie-consent-banner glass-panel"
    ...
    >
      <div class="cookie-consent-banner__copy">
        ...
        <h2 id="cookie-consent-title">Choose how Atlas uses optional analytics cookies</h2>
        <p id="cookie-consent-copy">
          Atlas always uses essential storage for sign-in, theme, onboarding, and offline reliability.
          Allow optional analytics cookies only if you want us to measure page usage, map interactions,
          and planning flows to improve the experience. You can change this later in Settings.
        </p>
      </div>
...
.cookie-consent-banner__actions :deep(.atlas-button) {
  min-width: 10rem;
}
