<template>
  <div class="search-bar" role="search">
    <ScopeIcon name="search" label="Search" class="search-bar__icon" />
    <input
      :value="inputValue"
    ...
    <button
      ...
      @click="clearSearch"
    >
      <ScopeIcon name="close" label="Clear search" />
    </button>
  </div>
</template>
...
const resolvedAriaLabel = computed(() => props.ariaLabel ?? props.label ?? 'Search Scope');
