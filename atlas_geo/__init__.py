...
def _load_native_module():
    ...
    for candidate in _candidate_paths():
        ...
        try:
            return importlib.import_module("_atlas_geo")
        except ModuleNotFoundError:
            continue

    raise ModuleNotFoundError(
        "atlas_geo native extension '_atlas_geo' is not built. "
        "Run the CMake build for atlas_geo before importing this package."
    )
