...
public final class AuthViewModel: @unchecked Sendable {
    ...
    @MainActor
    public func signIn(session: ScopeSession) async {
        error = nil
        isLoading = true
    ...
    @MainActor
    public func register(session: ScopeSession) async {
        error = nil
        isLoading = true
        defer { isLoading = false }
        do {
...
public final class SpotsViewModel: @unchecked Sendable {
    ...
    @MainActor
    public func load(using session: ScopeSession) async {
        isLoading = true
        defer { isLoading = false }
        do {
    ...
    @MainActor
    public func toggleFilter(_ category: SpotCategory?, session: ScopeSession) async {
        filter = category
