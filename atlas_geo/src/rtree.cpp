...
bool neighbor_less(const atlas::geo::NearestNeighbor& left, const atlas::geo::NearestNeighbor& right) {
...
bool point_less(const atlas::geo::SpatialPoint& left, const atlas::geo::SpatialPoint& right) {
