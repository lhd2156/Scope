    ...
    <div class="empty-state-panel__copy">
      <div class="empty-state-panel__copy-header">
        <div class="empty-state-panel__icon" aria-hidden="true">
          <ScopeIcon :name="resolvedLeadIcon" />
        </div>
...
.empty-state-panel__hero-icon :deep(.scope-icon) {
  width: 1.5rem;
  height: 1.5rem;
}
...
.empty-state-panel__orbit :deep(.scope-icon) {
  width: 1.1rem;
  height: 1.1rem;
}
...
.empty-state-panel__copy-header :deep(.scope-icon) {
  width: 1.2rem;
  height: 1.2rem;
}
