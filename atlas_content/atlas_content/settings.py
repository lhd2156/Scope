...
RATE_LIMIT_GLOBAL_PER_MINUTE = int(os.getenv('RATE_LIMIT_GLOBAL_PER_MINUTE', '100'))
RATE_LIMIT_UPLOADS_PER_MINUTE = int(os.getenv('RATE_LIMIT_UPLOADS_PER_MINUTE', '20'))
