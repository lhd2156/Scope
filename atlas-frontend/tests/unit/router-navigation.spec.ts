...
describe('router navigation matrix', () => {
  ...
  it('resolves the documented route table plus Atlas authoring routes', async () => {
  ...
  it('allows unauthenticated navigation to public routes without hydrating a protected session', async () => {
    const authStore = {
  ...
  it('redirects unauthenticated protected navigation to login and preserves the full redirect target', async () => {
    const authStore = {
      hasHydratedSession: false,
      isAuthenticated: false,
  ...
  it('redirects authenticated users away from guest-only routes and allows all protected routes through the real router', async () => {
    const authStore = {
      hasHydratedSession: true,
