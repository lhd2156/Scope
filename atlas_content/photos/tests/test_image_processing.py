...
@override_settings(
    AWS_STORAGE_BUCKET_NAME='atlas-bucket',
...
def test_s3_store_uploads_processed_original_and_thumbnail(monkeypatch) -> None:
    ...
    assert stored == {
        ...
        'storage_url': 'https://atlas-bucket.s3.us-east-1.amazonaws.com/photos/87654321-4321-8765-4321-876543218765.webp',
        'thumbnail_url': 'https://atlas-bucket.s3.us-east-1.amazonaws.com/photos/87654321-4321-8765-4321-876543218765_thumb.png',
    }
    assert uploads == [
        {
            'bucket': 'atlas-bucket',
