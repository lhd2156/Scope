  ...
  ...(import.meta.env.MODE === 'test'
    ? {
        __coverage: {
          ...
          draftStartLabel,
          draftStopCountLabel,
          driveScoreDifficultyLabel,
          driveScoreLabel,
          editableTimelineDays,
          fuelMetricTitle,
          handoffBudgetLabel,
          handoffDaysLabel,
          handoffStopCountLabel,
          handoffSummaryCopy,
          mapPickState,
          mapPickStatusCopy,
          mapLabelMode,
          maxEditableTimelineDay,
          planningRouteLabel,
          routeNearbyAllResults,
          routeNearbyAnchors,
          routeNearbyCurrentPage,
          routeNearbyDrawerOpen,
          routeNearbyDrawerTitle,
          routeNearbyEmptyLabel,
          routeNearbyFilterLabel,
          routeNearbyError,
          routeNearbyLoading,
          routeNearbyMapPlaces,
          routeNearbyMapPins,
          routeNearbyPinnedPlaces,
          routeNearbyResults,
          routeNearbySearchResults,
          routeDistanceLabel,
          routeEtaLabel,
          routeFuelCostLabel,
          showRouteMetrics,
          selectedRouteNearbyAnchorId,
          selectedRouteNearbyQueryId,
          selectedRouteNearbyTabId,
          selectedRouteNearbyRadiusOption,
          stepSummary,
          timelineDaySpan,
          timelineSourceStops,
          totalStops,
