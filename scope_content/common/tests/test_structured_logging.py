...
from common.logging_utils import ScopeContextFilter, ScopeJsonFormatter
...
def capture_json_logs(logger_name: str):
    ...
    handler.addFilter(ScopeContextFilter())
    handler.setFormatter(ScopeJsonFormatter('%(message)s'))
