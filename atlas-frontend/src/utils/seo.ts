...
const DEFAULT_TITLE = 'Atlas — Discover spots, map stories, and plan smarter trips';
const DEFAULT_DESCRIPTION = 'Atlas helps people discover community-loved spots, document real-world adventures with photos and stories, and build smarter itineraries with friends.';
