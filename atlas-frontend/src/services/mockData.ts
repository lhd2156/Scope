...
const friendRequestUsers: UserProfile[] = [
  {
    ...
    avatarUrl: buildPravatarAvatarUrl(23),
    bio: 'Building food-first city breaks with strong coffee and stronger itinerary notes.',
  ...
  },
  {
    ...
    avatarUrl: buildPravatarAvatarUrl(52),
    bio: 'Always looking for the next scenic overlook and a route that wastes zero daylight.',
    homeBase: 'Waco, TX',
...
const friendConnections: FriendConnection[] = [
  {
    ...
    nextAdventure: 'Dallas museum-to-riverwalk sprint',
  ...
  },
  {
    ...
    nextAdventure: 'Roma Norte dawn-to-dinner edit',
  ...
  },
  {
    ...
    nextAdventure: 'Gallery-and-courtyard circuit',
  ...
  },
  {
    ...
    nextAdventure: 'Blue-hour lookout chase',
...
const friendRequests: FriendRequest[] = [
  {
    ...
    mutualFriends: 9,
    note: 'Would love to trade Texas food routes and brunch-friendly gallery stops.',
  },
  {
    id: 'request-2',
    ...
    mutualFriends: 6,
    note: 'Saw your scenic saves and wanted to compare sunrise routes.',
  },
  {
    id: 'request-3',
...
const peopleYouMayKnow: PeopleYouMayKnowEntry[] = [
  {
    user: networkUsers[4],
    mutualFriends: 8,
    reason: 'Often saves scenic waterfront routes and aperitivo-led city walks.',
    favoriteCategories: ['scenic', 'food'],
  },
  {
    user: networkUsers[5],
    mutualFriends: 5,
    reason: 'Shares your adventure pace and keeps adding design-forward mountain routes.',
    favoriteCategories: ['adventure', 'nature'],
  },
  {
    user: networkUsers[6],
    mutualFriends: 7,
    reason: 'Strong overlap in culture, architecture, and market-first itineraries.',
    favoriteCategories: ['culture', 'shopping'],
  },
];
...
const spotReviewSeeds: Record<string, ReviewSeed[]> = {
  'spot-1': [
    ...
    },
    {
      user: networkUsers[4],
      rating: 4.8,
      comment: 'Exactly the kind of dinner-to-nightlife handoff Atlas routes need — strong food, better views, zero friction.',
  ...
  const seeds = spotReviewSeeds[spotId] ?? [
    {
      user: users[1],
      rating: 4.7,
      comment: 'Premium pacing, strong visuals, and easy to build into a full Atlas day.',
      createdAt: '2026-03-26T22:00:00Z',
    },
  ];
...
const trips: Trip[] = [
  {
    ...
    coverImageUrl: baseSpots[6].photoUrl,
    budget: 340,
    currency: 'USD',
    status: 'planning',
  },
