...
/// Scope design tokens mirrored from `scope-assets/design-tokens.css`. Keep
/// the palette in sync with the web client so every platform feels like Scope.
