...
export const DEMO_LOGIN_EMAIL = 'demo@atlas.travel';
export const DEMO_LOGIN_PASSWORD = 'Atlas2024!';
export const DEMO_LOGIN_ERROR_MESSAGE = `Use ${DEMO_LOGIN_EMAIL} / ${DEMO_LOGIN_PASSWORD} to enter Atlas demo mode.`;
