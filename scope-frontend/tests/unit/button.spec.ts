...
describe('Button', () => {
  it('renders icon buttons with the requested variant class', () => {
    ...
    expect(wrapper.classes()).toContain('scope-button--secondary');
    expect(wrapper.find('.scope-icon').exists()).toBe(true);
  ...
  it('disables the button and shows a spinner while loading', () => {
    ...
    expect(wrapper.classes()).toContain('scope-button--block');
