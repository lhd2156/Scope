# Atlas Frontend Design Specification

**READ THIS ENTIRE FILE BEFORE WRITING ANY FRONTEND CSS OR TEMPLATE CODE.**

This document is the authoritative visual design reference for Atlas. Every page, component, and interaction must follow these specs exactly. The goal is a **premium, world-class travel platform** that rivals Nike.com, Instagram, TripAdvisor, and Airbnb in visual polish.

---

## Design Philosophy

Atlas is NOT a generic SaaS dashboard. It is:
...
All mockup images are in `atlas-assets/mockups/`. Study these carefully:
...
**Layout:**
- Split-screen: left half is a full-height stunning travel hero photo with dark gradient overlay and Atlas branding, right half is the login form
- Right side: dark background, centered glassmorphism card with:
  - "Welcome back" teal eyebrow
  - "Sign in to Atlas" heading
...
5. ❌ DO NOT skip the glassmorphism effect on major panels — it's the signature Atlas look
