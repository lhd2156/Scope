...
/// ```
@Observable
public final class AtlasSession: @unchecked Sendable {
    public let environment: AtlasEnvironment
    ...
    public private(set) var currentUser: AtlasUser?
    ...
    public static func live() -> AtlasSession {
