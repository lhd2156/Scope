...
const APP_SHELL_CACHE = `atlas-shell-${SERVICE_WORKER_VERSION}`;
const STATIC_ASSET_CACHE = `atlas-static-${SERVICE_WORKER_VERSION}`;
const NAVIGATION_CACHE = `atlas-navigation-${SERVICE_WORKER_VERSION}`;
