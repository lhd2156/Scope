<template>
  <section class="glass-panel profile-map" data-test="profile-map">
      ...
      <div class="footprint-stage surface-card">
        ...
        <article class="spotlight-card glass-panel">
          ...
          <div v-if="selectedSpot" class="spotlight-copy">
            ...
            <span>{{ selectedSpot.city || 'Scope community pin' }}</span>
          </div>
        </article>
      </div>
    ...
    <EmptyStatePanel
      ...
      description="When this explorer publishes places to Scope, their global footprint will glow here first."
      icon="map"
      artwork="profile"
      heading-level="h3"
    />
...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    description: 'A premium snapshot of the places this explorer has surfaced to Scope.',
  },
);
