...
defineExpose(import.meta.env.MODE === 'test'
  ? {
      __coverage: {
        ...
        formatRouteDistance,
        formatRouteDuration,
        formatSpotCityRegion,
        formatSpotCountryBadge,
        formatSpotFullLocation,
        getAdjacentMobileSheetState,
        getFallbackPhoto,
        getMemberInitials,
        getSpotPhotoUrl,
        handleCategoryToggle,
        handleDismissMapSpotOverlay,
        handleFeaturedRouteCardClick,
        handleMapInteraction,
        handleMobileSheetDrag,
        ...
        hasLoadedSpotData,
        hasLoadedTripData,
        ignoreNextMobileSheetClick,
        isFeaturedRoutePreviewPinned,
        isDraggingMobileSheet,
        isMobileMapLayout,
        isMapSidebarScrolled,
        isSelectedMapOverlayVisible,
        isRouteDescriptionPlaceholder,
        labelRouteMapPoints,
        loadLocalMapPreviewData,
        localPreviewSpots,
        localPreviewTrip,
        ...
        mapViewStyle,
        mergeSpotSources,
        mobileSheetAriaLabel,
        mobileSheetDescription,
        mobileSheetDragOffset,
        mobileSheetDragStartY,
        mobileSheetHeadline,
        mobileSheetState,
        mobileSheetStyle,
        mobileSheetVisibleHeight,
        nextMobileSheetState,
        recordMapInteraction,
        revealMobileSheet,
        resolveIsMobileMapLayout,
        roadRoute,
        roadRouteLoading,
        routeDescription,
        routeDestinationDisplay,
        ...
        routeTitle,
        routeTravelerMetric,
        selectedMapOverlayLocation,
        selectedMapOverlayPhoto,
        selectedMapOverlaySpot,
        selectedSpot,
        selectedSpotCountryBadge,
        ...
        syncFocusedMapSpot,
        syncMapBaseViewportFromPreferredLocation,
        syncMapSidebarScrollState,
        syncMobileMapLayout,
        syncRoadRoute,
        toWorkspaceSpot,
