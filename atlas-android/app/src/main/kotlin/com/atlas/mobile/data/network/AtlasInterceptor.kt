...
class AuthInterceptor @Inject constructor(private val store: TokenStore) : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val builder = chain.request().newBuilder()
            ...
            .addHeader("User-Agent", "atlas-android/1.0")
 ...
 */
@Singleton
class AtlasAuthenticator @Inject constructor(
    ...
    override fun authenticate(route: okhttp3.Route?, response: Response): okhttp3.Request? {
        if (response.request.header("X-Atlas-Retried") != null) return null
        ...
        return response.request.newBuilder()
            ...
            .header("X-Atlas-Retried", "1")
            .build()
    }
}

fun interface TokenRefresher {
    suspend fun refresh(refreshToken: String): AtlasTokens?
}
