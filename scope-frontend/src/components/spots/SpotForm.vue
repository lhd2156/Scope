...
defineExpose({
  ...(import.meta.env.MODE === 'test'
    ? {
      __coverage: {
        activeStepId,
        applyGeocodeResultToForm,
        buildVerificationSignature,
        clearError,
        clearServerRejectionFor,
        clonePhotos,
        composerSteps,
        coverPreviewUrl,
        createDefaultForm,
        ...
        formatCategory,
        formatPillar,
        getNearestPinnedPlace,
        handleCategorySelect,
        handlePhotoSelection,
        handlePinMapClick,
        handleSubmit,
        hasPinnedCoordinates,
        hasProviderPlaceDetails,
        heading,
        isLocationVerified,
        isPhotoLimitReached,
        isPreciseGeocodeResult,
        isReadyToPublishPublic,
        isServerFieldHighlighted,
        isValidLatitude,
        isValidLongitude,
        markVerificationStale,
        ...
        normalizeForm,
        photoPreviewItems,
        pillarSelectionReady,
        pinMapPoints,
        pinMapViewport,
        placeVerification,
        previewSubtitle,
        previewTitle,
        privateDraftDisabled,
        publicSafetyReady,
        publishDisabled,
        readCategorySignals,
        readinessItems,
