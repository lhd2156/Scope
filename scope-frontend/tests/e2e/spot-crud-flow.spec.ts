...
const updatedSpot = {
  ...
  description: 'An updated Scope pin with sharper copy, moodier lighting notes, and a more premium nighttime cue.',
  vibe: 'moonlit social',
  rating: '4.9',
};
...
test.describe('spot CRUD flow', () => {
  test('creates, edits, views, deletes, and verifies removal of a spot with deterministic mocks', async ({ page, scopeApi }) => {
